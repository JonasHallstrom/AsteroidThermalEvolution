...
if __name__ == '__main__':
    ...
    T_s = 200 # K, should be greater than ~135 K to avoid cp becoming negative! Also T_0
    ...
    geo_spacing = True  # Option for spacing shell positions out by a geometric sequence, not usually needed
    ...
    simulation_nickname = "_TestC"  # string to append to names of results files, leave as empty string if none wanted
    ...
    density = 1  # [kg/m^3], does not matter for this model because it cancels out of the conduction equation
