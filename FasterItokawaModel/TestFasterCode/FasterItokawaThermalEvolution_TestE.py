...
if __name__ == '__main__':
    ...
    t_form_kyr = 2100  # kyr or ka
    tot_rad = 30_000  # meters
    ...
    num_shells = 201  # Recommend: 101 for smaller bodies (~5 km) and up to 301 for larger bodies (~50-100 km)
    ...
    simulation_nickname = "_TestE"  # string to append to names of results files, leave as empty string if none wanted
