...
if __name__ == '__main__':
    ...
    kappa_multiplier = 90  # percent (100 would be default)
    cp_multiplier = 90  # percent (100 would be default)
    heat_multiplier = 90  # percent (100 would be default)
    ...
    simulation_nickname = "_TestD"  # string to append to names of results files, leave as empty string if none wanted
