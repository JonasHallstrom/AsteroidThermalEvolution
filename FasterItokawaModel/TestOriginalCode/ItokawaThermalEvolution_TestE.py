...
if __name__ == '__main__':
    ...
    num_shells = 201  # Recommend: 100 for smaller bodies and up to 300 for larger bodies
    ...
    file_name = 'ItokawaResults_TestE.txt'  # Name of .txt file that will be saved
    figure_name = 'ItokawaResults_TestE.png'  # name of .png file that will be saved
