...
if __name__ == '__main__':
    ...
    geo_spacing = True  # Option for spacing shell positions out by a geometric sequence
    ...
    file_name = 'ItokawaResults_TestC.txt'  # Name of .txt file that will be saved
    figure_name = 'ItokawaResults_TestC.png'  # name of .png file that will be saved
