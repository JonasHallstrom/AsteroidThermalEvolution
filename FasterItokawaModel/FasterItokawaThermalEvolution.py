...
if __name__ == '__main__':
    ...
    T_s = 200 # K, should be greater than ~135 K to avoid cp becoming negative!
    ...
    simulation_nickname = ""  # string to append to names of results files, leave as empty string if none wanted
